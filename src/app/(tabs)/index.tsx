			...
			<View className="bg-gray-100 h-full">
				...
				<View className="p-4 gap-2 mt-14">
					<Animatable.View className="flex-row gap-4" animation={"slideInLeft"}>
						<View className="shadow bg-white flex-1 rounded-3xl p-4 gap-3">
							<View>
				...
				<View className="flex-row shadow-sm items-center justify-between bg-gray-100 border border-gray-200 rounded-3xl mx-4">
					<WifiStatus />
					<UsageData />
				</View>
				<BottomSheet
